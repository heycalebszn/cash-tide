...
const FinanceSection = forwardRef<HTMLDivElement>((props, ref: Ref<HTMLDivElement>) => {
  ...
  return (
    <div ref={ref} className="relative bg-white h-screen overflow-hidden">
      ...
      <h1 ref={h1Ref} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-6xl leading-[60px] text-gradient font-extrabold z-50 w-full text-center md:text-[160px] md:leading-[200px]">Frictionless <br /> Crypto Flow</h1>
